...
(function (factory) {
    ...
    k.o = function () {
        ...
        this.run = function () {
            ...
            this.o = $.extend({
	                ...
	                fgColor: this.$.data('fgcolor') || '#ebcd36',
                   
					
						fgColorMid : this.$.data('fgcolormid') || this.$.data('fgcolor') || '#d92e2e',
						fgColorEnd : this.$.data('fgcolorend') || this.$.data('fgcolor') || '#ebcd36',
						inputColor: this.$.data('color') || '#f5f5f5',
    ...
    k.Dial = function () {
        ...
        this.extend = function () {
            this.o = $.extend({
                bgColor: this.$.data('bgcolor') || '#232934',
